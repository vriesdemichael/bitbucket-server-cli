...
var dryRunProfiles = map[string]dryRunProfile{
	...
	"repo settings security permissions users grant":   {Intent: "repo.permission.user.grant", Action: "update", PlanningMode: planningModeStatic, Capability: capabilityPartial, CapabilityMsg: "static preview only"},
	"repo settings security permissions users revoke":  {Intent: "repo.permission.user.revoke", Action: "delete", PlanningMode: planningModeStatic, Capability: capabilityPartial, CapabilityMsg: "static preview only"},
	"repo settings security permissions groups grant":  {Intent: "repo.permission.group.grant", Action: "update", PlanningMode: planningModeStatic, Capability: capabilityPartial, CapabilityMsg: "static preview only"},
	"repo settings security permissions groups revoke": {Intent: "repo.permission.group.revoke", Action: "delete", PlanningMode: planningModeStatic, Capability: capabilityPartial, CapabilityMsg: "static preview only"},
	...
	"reviewer create":                                  {Intent: "reviewer.condition.create", Action: "create", PlanningMode: planningModeStatic, Capability: capabilityPartial, CapabilityMsg: "static preview only"},
	"reviewer update":                                  {Intent: "reviewer.condition.update", Action: "update", PlanningMode: planningModeStatic, Capability: capabilityPartial, CapabilityMsg: "static preview only"},
	"reviewer delete":                                  {Intent: "reviewer.condition.delete", Action: "delete", PlanningMode: planningModeStatic, Capability: capabilityPartial, CapabilityMsg: "static preview only"},
...
func writeDryRunPreview(writer io.Writer, asJSON bool, preview dryRunPreview) error {
	...
	for _, item := range preview.Items {
		if _, err := fmt.Fprintf(writer, "- intent=%s action=%s\n", item.Intent, item.Action); err != nil {
			return err
		}
